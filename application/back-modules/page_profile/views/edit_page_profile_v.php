...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<div class="row">
					<form id="form-edit-page_profile" name="form-edit-page_profile" class="form-horizontal" role="form" method="post" action="<?php echo base_url();?>page_profile/update" enctype="multipart/form-data">
						<div class="col-md-8">
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-10">
							    	<textarea id="content" name="content" class="form-control" placeholder="Type the content" rows="15" style="width:100%;">
							    		<?php echo $page_profiles['content'];?>
							    	</textarea>
							    </div>
							</div>
							<div class="form-group">
